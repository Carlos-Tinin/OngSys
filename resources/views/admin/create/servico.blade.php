...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">{{ __('Cadastro de servicos') }}</div>

            <div class="card-body">
                <form method="POST" action="{{ route('admin.create.servico') }}" aria-label="{{ __('Register') }}">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="titulo" type="text" class="form-control{{ $errors->has('titulo') ? ' is-invalid' : '' }}" name="titulo" value="{{ old('titulo') }}" required autofocus placeholder="Digite um titulo para o servico">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <textarea id="info" rows="4" maxlength="150" class="form-control{{ $errors->has('info') ? ' is-invalid' : '' }}" name="info" value="{{ old('info') }}" required placeholder="Descrição geral sobre o servico..."></textarea>
                        ...
                        <div class="col-md-6">
                        	<select class="form-control" name="pessoa[]" id="pessoa" multiple required="">
                                    @forelse ($pessoas as $pessoa)
                                    	<option value="{{$pessoa->id}}">{{strtoupper($pessoa->nome)}}</option>
                                	@empty
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="fechamento" type="date" min="" class="form-control{{ $errors->has('fechamento') ? ' is-invalid' : '' }}" name="fechamento" value="{{ old('fechamento') }}" required>
